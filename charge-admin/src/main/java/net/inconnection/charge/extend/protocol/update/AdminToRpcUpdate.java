package net.inconnection.charge.extend.protocol.update;
...
import net.inconnection.charge.extend.utils.RedisUtil;
import net.inconnection.charge.extend.utils.SEQGeneration;
...
import static net.inconnection.charge.extend.protocol.ProtocolConstant.MSG_UPDATE_PROCESS_PORT;
import static net.inconnection.charge.extend.protocol.ProtocolConstant.MSG_UPDATE_WEB_PORT;
import static net.inconnection.charge.extend.protocol.ProtocolConstant.TOPIC_UPDATE;
