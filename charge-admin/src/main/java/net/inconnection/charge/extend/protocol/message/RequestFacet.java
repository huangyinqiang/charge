...
import static net.inconnection.charge.extend.protocol.ProtocolConstant.MSG_COMPONENT_SEPARATOR;
import static net.inconnection.charge.extend.protocol.ProtocolConstant.MSG_REQUEST;
