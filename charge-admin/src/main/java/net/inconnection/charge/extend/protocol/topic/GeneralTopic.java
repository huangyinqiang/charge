package net.inconnection.charge.extend.protocol.topic;

import java.util.Vector;

import static net.inconnection.charge.extend.protocol.ProtocolConstant.MQTT_TOPIC_CUR_VERSION;
import static net.inconnection.charge.extend.protocol.ProtocolConstant.MQTT_TOPIC_TO_POINT;
