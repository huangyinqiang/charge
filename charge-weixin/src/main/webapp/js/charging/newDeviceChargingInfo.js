...
$(function () {
    ...
    // dropload
    $('.codePay-inner').dropload({
        scrollArea: window,
        domUp: {
            domClass: 'dropload-up',
            domRefresh: '<div class="dropload-refresh">↓下拉刷新-充电记录</div>',
            domUpdate: '<div class="dropload-update">↑释放更新-充电记录</div>',
            domLoad: '<div class="dropload-load"><span class="loading"></span>加载中-充电记录...</div>'
        },
        domDown: {
            domClass: 'dropload-down',
            domRefresh: '<div class="dropload-refresh">↑上拉加载更多-充电记录</div>',
            domLoad: '<div class="dropload-load"><span class="loading"></span>加载中-充电记录...</div>',
        ...
        loadUpFn: function (me) {
            ...
            $.ajax({
            	type : 'POST',
            	data : data,
    			url : "../charging/queryChargingInfo",
    			dataType : "json",
