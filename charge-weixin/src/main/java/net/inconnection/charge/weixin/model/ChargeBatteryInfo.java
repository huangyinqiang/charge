...
public class ChargeBatteryInfo extends Model<ChargeBatteryInfo> {
    ...
    public boolean addChargeLog(ChargeBatteryInfoBean chargeBatteryInfoBean) {
        ...
        info.set("feeStatus", chargeBatteryInfoBean.getStatus());
    ...
    public Page<Record> queryAllByOpenId(String openId, int pageNumber, int pageSize) {
        ...
        Page<Record> page = Db.paginate(pageNumber, pageSize, "SELECT a.id,a.charge,a.feeStatus,a.deviceId,a.devicePort,a.startTime,a.operStartTime,a.endTime, q.area", "FROM charge_battery_info a LEFT JOIN qr_match_device q on a.deviceId = q.match_num where a.openId = '" + openId + "' order by id desc");
